...
export const metadata: Metadata = {
  ...
  description:
    "軽貨物ドライバーが初めての方へ。株式会社ウィランは横乗り研修・未経験者向け研修・日額20,500円〜の日額保証で未経験からのスタートを支えます。必要なのは普通免許（AT限定可）だけ。東京・千葉で募集中。",
  alternates: { canonical: "/beginner" },
  openGraph: {
    title: "未経験から始める軽貨物ドライバー｜株式会社ウィラン",
    description:
      "横乗り研修・日額20,500円〜の保証・車両リースあり。未経験からのスタートを支える仕組みを紹介します。",
    url: "/beginner",
    type: "website",
  },
};
...
const worries = [
  ...
  },
  {
    ...
    answer:
      "日額保証（規定あり・エリアにより日額20,500〜22,000円）があるため、配達スピードが上がる前でも収入の見通しが立ちます。宅配は、担当エリアの道と建物を覚えるほど配達が速くなる仕事です。慣れるまでの期間には個人差があります。",
  },
  {
    worry: "車を持っていない",
    answer:
