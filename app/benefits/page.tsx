...
export const metadata: Metadata = {
  ...
  description:
    "株式会社ウィランで軽貨物ドライバーとして働くメリットを紹介。日額20,500円〜（エリアにより異なる）・週払い可・車両リース月額30,000円・横乗り研修・独立支援制度・税理士紹介など、未経験でも始めやすいサポート体制です。",
  alternates: { canonical: "/benefits" },
  openGraph: {
    title: "ウィランで働くメリット｜株式会社ウィラン",
    description:
      "日額20,500円〜・週払い可・車両リース・研修・独立支援。ウィランで働くメリットを紹介します。",
    url: "/benefits",
    type: "website",
  },
};
...
const bigMerits = [
  {
    title: "日額20,500円〜の報酬保証",
    text: "出来高制のみの契約が多い業界で、ウィランはエリアにより日額20,500〜22,000円を保証（規定あり）。配達件数が伸びない時期も、収入の見通しを立てて働けます。",
  },
  {
    title: "週払いに対応",
  ...
  {
    title: "車がなくても始められる",
    text: "配送用の軽バンを月額30,000円でリース可能。持ち込みや車の購入代行もOKで、初期投資を抑えて始められます。",
  },
  {
    title: "未経験前提の研修",
