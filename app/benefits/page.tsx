...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "日額20,000円〜・週払い可・車両リース・研修・独立支援。ウィランで働くメリットを紹介します。",
    url: "/benefits",
    type: "website",
  },
};
...
const bigMerits = [
  {
    title: "日額20,000円〜の報酬保証",
    text: "出来高制のみの契約が多い業界で、ウィランはエリアにより日額20,000〜22,000円を保証（規定あり）。配達件数が伸びない時期も、収入の見通しを立てて働けます。",
  },
  {
    title: "週払いに対応",
